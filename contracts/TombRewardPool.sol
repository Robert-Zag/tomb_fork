...
contract TombRewardPool {
    ...
    modifier onlyOperator() {
        require(
            operator == msg.sender,
            "TombRewardPool: caller is not the operator"
        );
        _;
    }
